...
const AddProduct = ({categories}) => {
     ...
     // form data နဲ့ post method ကို setup လုပ်တာပါ
        const { data, setData, post, processing, errors, reset } = useForm({
          name  : '', price : '', stock : '', description : '' , image : null , category_id : '' // input ရဲ့ name နဲ့ တူရပါမယ်
        });


        const submit = (e) => {
        e.preventDefault();
        post(route('createProduct'), { // Controller ဆီပို့မယ့် URL (Route လမ်းကြောင်း)
            onSuccess: () => {
                reset();
                alert('Success!');
    ...
    // ပုံ Preview ကြည့်ဖို့အတွက် state တစ်ခုပဲ သုံးထားပါတယ်
                        ...
                        <div className="card-body p-4">
                            <form onSubmit={submit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <textarea className="form-control" rows="4" placeholder="Write product details here..." 
                                ...
                                <div className="mt-4">
                                    <button type="submit" className="btn btn-primary btn-block shadow-sm py-2">
                                        <i className="fas fa-save mr-2"></i>Create Product
                                    </button>
                                </div>
                            </form>
                        </div>
